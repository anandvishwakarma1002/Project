...
class MainMenuWindow(ttk.Frame):
    """ Main Menu for Store Management System"""
    def __init__(self, master):
        ...
        program_title_label.place(x=160, y=40)

        # Sales Button
        self.sales_btn_img = tk.PhotoImage(file = r"images/sales_button.png")
        sales_button = tk.Button(body_frame, text="Sales", image=self.sales_btn_img, bd=0,
        ...
        inventory_button = tk.Button(body_frame , text="Inventory", image=self.inventory_btn_img, bd=0,
        ...
        extras_button = tk.Button(body_frame , text="Extras", image=self.extras_btn_img, bd=0,
        ...
        exit_button = tk.Button(body_frame , text="Exit", image=self.exit_btn_img, bd=0,
                                command=master.quit)
